        ...
        json.forEach(jsonElement -> {
            if (jsonElement.isJsonArray()) {
                ...
                if (jsonPrimitive.isBoolean()) {
                    ...
                    DonationHavok.getInstance().getLogger().warn("Invalid Json detected: " + jsonPrimitive.toString());
                }
            }
            else {
                JOptionPane.showConfirmDialog(null, "Invalid JSON detected. Check log for more info.", "Invalid JSON!", JOptionPane.DEFAULT_OPTION);
                DonationHavok.getInstance().getLogger().warn("Invalid Json detected: " + jsonElement.toString());
            }
        });
    }
