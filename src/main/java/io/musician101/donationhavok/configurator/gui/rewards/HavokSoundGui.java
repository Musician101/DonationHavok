...
public class HavokSoundGui {/*extends BaseGui {
    ...
    private JPanel soundPanel(HavokSound sound) {
        ...
        soundComboBox = new JComboBox<>(new SortedComboBoxModel<>(StreamSupport.stream(ForgeRegistries.SOUND_EVENTS.spliterator(), false).collect(Collectors.toList()), Comparator.comparing(o -> Objects.requireNonNull(o.getRegistryName()).toString())));
