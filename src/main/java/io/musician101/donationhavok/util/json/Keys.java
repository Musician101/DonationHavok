...
public class Keys {
    ...
    //public static final JsonKeyImpl<JsonArray, TreeMap<Double, HavokRewards>> REWARDS = key("rewards", new TypeToken<TreeMap<Double, HavokRewards>>() {}, new RewardsMapSerializer());
